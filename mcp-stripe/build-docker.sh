...
# Multi-platform Docker build script for Stripe MCP Server
# Builds for linux/amd64 and linux/arm64

set -e

IMAGE_NAME="ghcr.io/dunialabs/mcp-servers/stripe"
...
echo ""
echo "🧪 Test locally:"
echo "  docker run -i --rm -e STRIPE_SECRET_KEY=sk_test_xxx ${IMAGE_NAME}:latest"
echo ""
echo "Usage:"
