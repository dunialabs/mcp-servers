...
# Multi-platform Docker build script for mcp-notion
# Builds for linux/amd64 and linux/arm64

set -e

IMAGE_NAME="ghcr.io/dunialabs/mcp-servers/notion"
...
echo ""
echo "🧪 Test locally:"
echo "  export notionToken='secret_xxx...'"
echo "  docker run -i --rm -e notionToken ${IMAGE_NAME}:latest"
echo ""
echo "Usage:"
