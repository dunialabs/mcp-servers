...
# Multi-platform Docker build script for MySQL MCP Server
# Builds for linux/amd64 and linux/arm64

set -e

IMAGE_NAME="ghcr.io/dunialabs/mcp-servers/mysql"
...
echo ""
echo "Test locally:"
echo "  docker run -i --rm -e MYSQL_URL=\"mysql://user:password@host:3306/db\" ${IMAGE_NAME}:latest"
echo ""
echo "Usage:"
